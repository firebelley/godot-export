...
if (ANDROID_DEBUG_KEYSTORE_PATH) core.exportVariable('GODOT_ANDROID_KEYSTORE_DEBUG_PATH', ANDROID_DEBUG_KEYSTORE_PATH);
if (ANDROID_DEBUG_KEYSTORE_USERNAME) core.exportVariable('GODOT_ANDROID_KEYSTORE_DEBUG_USER', ANDROID_DEBUG_KEYSTORE_USERNAME);
if (ANDROID_DEBUG_KEYSTORE_PASSWORD) core.exportVariable('GODOT_ANDROID_KEYSTORE_DEBUG_PASSWORD', ANDROID_DEBUG_KEYSTORE_PASSWORD);
if (ANDROID_RELEASE_KEYSTORE_PATH) core.exportVariable('GODOT_ANDROID_KEYSTORE_RELEASE_PATH', ANDROID_RELEASE_KEYSTORE_PATH);
if (ANDROID_RELEASE_KEYSTORE_USERNAME) core.exportVariable('GODOT_ANDROID_KEYSTORE_RELEASE_USER', ANDROID_RELEASE_KEYSTORE_USERNAME);
if (ANDROID_RELEASE_KEYSTORE_PASSWORD) core.exportVariable('GODOT_ANDROID_KEYSTORE_RELEASE_PASSWORD', ANDROID_RELEASE_KEYSTORE_PASSWORD);
