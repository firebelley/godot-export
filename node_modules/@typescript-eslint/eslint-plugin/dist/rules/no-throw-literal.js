...
exports.default = util.createRule({
    ...
    create(context) {
        ...
        function isErrorLike(type) {
            ...
            if (((_a = symbol) === null || _a === void 0 ? void 0 : _a.getName()) === 'Error') {
                const declarations = (_b = symbol.getDeclarations(), (_b !== null && _b !== void 0 ? _b : []));
            ...
            const baseTypes = (_c = type.getBaseTypes(), (_c !== null && _c !== void 0 ? _c : []));
