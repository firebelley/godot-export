...
function createIsolatedProgram(code, extra) {
    ...
    const compilerHost = {
        ...
        getSourceFile(filename) {
            return ts.createSourceFile(filename, code, ts.ScriptTarget.Latest, true, shared_1.getScriptKind(extra, filename));
        },
        readFile() {
            return undefined;
        },
    ...
    const program = ts.createProgram([extra.filePath], Object.assign({ noResolve: true, target: ts.ScriptTarget.Latest, jsx: extra.jsx ? ts.JsxEmit.Preserve : undefined }, shared_1.DEFAULT_COMPILER_OPTIONS), compilerHost);
