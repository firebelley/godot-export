...
const validateParameterNames = (targetTagName, functionParameterNames, jsdoc, jsdocNode, utils, report) => {
  if (!jsdoc || !jsdoc.tags) {
    return false;
  }

  const paramTags = (0, _object.default)(jsdoc.tags).filter(([, tag]) => {
...
const validateParameterNamesDeep = (targetTagName, jsdocParameterNames, jsdoc, report) => {
